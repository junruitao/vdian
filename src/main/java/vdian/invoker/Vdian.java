...
public class Vdian {
	...
	private static final Logger log = LoggerFactory.getLogger(Vdian.class);

	public static void main(String args[]) throws Exception {
		String userId = "334916496";
...
//				
//				url = "http://item.weidian.com/wd/item/getPubInfo?param="+URLEncoder.encode("{\"itemID\":1533830453,\"page\":1}", "UTF-8");
//				uri = new URI(url);
